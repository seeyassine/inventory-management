 ...
 */
final class Version20251214222704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD emplacement_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_29A5EC27C4598A51 ON produit');
        $this->addSql('ALTER TABLE produit DROP emplacement_id');
    }
}
